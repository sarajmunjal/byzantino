...
class Node_(da.NodeProcess):
    ...
    def run(self):
        ...
        olympus = self.new(olympus_module.Olympus, args=('Olympus', replica_config.num_replica, replica_config.failures, replica_config.head_timeout, replica_config.nonhead_timeout))
        self._start(olympus)
        clients = list()
